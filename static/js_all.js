...
var Chart, Dashboard, activateListeners, all, averageValues, avgTempByMonth, buildCalendarJson, buildFakeGroup, cal, calculateIntervals, chart, checkAvg, dataSlice, dateDim, dayOfWeek, db, defaultClipsArray, getColorIndex, getDeltas, hourChart, monthChart, monthDim, monthNameDim, months, ndx, parseDate, precipReduceHack, seasonChart, seasonDim, startTime, t1, timeChart, timeSeries, yearChart,
...
Dashboard = (function() {
  ...
  Dashboard.prototype.parseData = function(data) {
    ...
    $("#lowerHalf").height(this.lowerHeight);
