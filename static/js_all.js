...
Dashboard = (function() {
  function Dashboard() {
    ...
    this.upperHeight = $("#upperHalf .leftCol").width() * .333;
  ...
  Dashboard.prototype.parseData = function(data) {
    ...
    return this.buildTimeSeriesChart();
  };
  ...
  Dashboard.prototype.buildMonthChart = function() {
    ...
    thisChart.chartObject.dimension(this.dimension.monthNames).width(thisChart.width + 75).height(this.upperHeight).yAxisLabel(this.displayName).elasticY(true).x(d3.scale.ordinal().domain(this.monthArray)).xUnits(dc.units.ordinal).renderHorizontalGridLines(true).compose([actualValuesChart]).renderlet(function() {
  ...
  Dashboard.prototype.activateListeners = function() {
    ...
    $("#upperHalf .rightCol").on("click", "button", function() {
      var queryString;
    ...
    return $(this.inputBox).keypress(function(e) {
      ...
      if (e.which === 13) {
        console.log("clicked");
        return $("#upperHalf .rightCol button").click();
      }
    });
  };

  Dashboard.prototype.loadCalendar = function() {
    var begin, cellSize, end, interval, json, max, metricValues, numOfMonths;
